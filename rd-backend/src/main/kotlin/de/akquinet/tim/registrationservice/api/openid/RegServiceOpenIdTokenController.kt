...
package de.akquinet.tim.registrationservice.api.openid

import de.akquinet.tim.registrationservice.service.openid.ErrorResult
import de.akquinet.tim.registrationservice.service.openid.MatrixTokenToRegServiceOpenIdTokenConverterService
import de.akquinet.tim.registrationservice.service.openid.SuccessResult
import de.akquinet.tim.registrationservice.service.openid.TokenConverterResultErrorType
...
class RegServiceOpenIdTokenController(
    ...
    fun exchangeSynapseAccessCodeForRegServiceOpenIdToken(
        ...
        when (val tokenConvertResult = tokenConverter.convertTokenForUser(userId, request_token)) {
            ...
            is ErrorResult -> checkResultErrorType(tokenConvertResult)
        }

    private fun checkResultErrorType(tokenConvertResult: ErrorResult): ResponseEntity<TokenResponse> =
        when (tokenConvertResult.errorType) {
