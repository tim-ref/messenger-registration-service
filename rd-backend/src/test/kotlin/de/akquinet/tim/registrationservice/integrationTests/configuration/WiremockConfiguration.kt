...
package de.akquinet.tim.registrationservice.integrationTests.configuration
...
internal class WiremockConfiguration(
    ...
    fun operatorWireMockServer(): WireMockServer {
        val operatorWireMock = WireMockServer(
            WireMockConfiguration.options().port(operatorConfig.properties.port.toInt()))
        ...
        operatorWireMock.post {
            urlPath like "${operatorConfig.properties.createPath}/${instanceNameRegex}/admin"
        } returns {
        ...
        operatorWireMock.get {
            urlPath like "${operatorConfig.properties.createPath}/${instanceNameRegex}/ready"
        } returns {
            statusCode = HttpStatus.OK.value()
        }
